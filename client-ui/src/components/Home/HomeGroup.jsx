...
import { Carousel } from "../Factories";

import ProductSlider from "./MainComponent/ProductSlider";
import BusinessStrategyCard from "./MainComponent/BusinessStrategyCard";

import "../../sass/main.scss";
import { useFirebase } from "../../firebase/FirebaseContext";

const HomeGroup = ({ setLoading, user }) => {
  ...
  const [cards] = useState([
    {
      ...
      title: "PERUSAHAAN",
      description: "Since 2010 - Present.",
    },
    {
      icon: (
        <svg
      ...
      title: "PRODUK",
      description:
        "Produk yang diproduksi sangat bermanfaat misalnya produk kecantikan maupun kesehatan.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Sistem yang mudah dan simple untuk siapapun yang ingin menjalankannya.",
    },
    {
      icon: (
        <svg
      ...
      title: "PROMOSI",
      description: "Promosi bisa anda lakukan dimanapun dan kapapun.",
    },
  ]);
  ...
  return (
    <main className="home">
      ...
      <ProductSlider
        ...
        sliderRef={slider}
      />
      <BusinessStrategyCard cards={cards} />
    </main>
  );
};
